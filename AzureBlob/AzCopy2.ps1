...
# Source: https://gist.github.com/jtabuloc/0b80cd55630dd4bdf426681c6be7382b
# Dependencies :
...
function Copy-AzureStorageTable
{
    ...
    foreach($table in $SrcTables)
    {
        ...
        .\AzCopy\AzCopy.exe /Source:$SrcTableUrl `
        ...
        foreach($blob in $CurrentBlob)
        {
            ...
            .\AzCopy\AzCopy.exe /Source:$DstBlobUrl/$TableName `
